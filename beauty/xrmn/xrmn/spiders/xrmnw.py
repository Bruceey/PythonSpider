...
class XrmnwSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.xiu01.top/XiuRen/2024/202415711.html',
                  ]
    ...
    #         # # 先爬前10页，之后11-15，
    #         # group_page_links = group_page_links[10: 15] if len(group_page_links) > 10 else group_page_links
    #         #####################
    ...
    def parse_group_link(self, response):
        ...
        if title is None:
            ...
            for link in page_links:
                ...
                yield scrapy.Request(link, callback=self.parse_group_link, meta={'title': title, 'author': author})
        ...
        yield XrmnItem(image_urls=image_urls, image_serials=image_serials, title=title, author=author)
